...
require "../PAGE_LOGIC/LgAgentTicket.php";
//require "../PAGE_LOGIC/Other_utils.php";
$tick = new LgAgentTicket();
$others = new Other_utils();

$ticketID = $_GET["tket"];
$_SESSION['ticket_id'] = $_GET["tket"];
$open_tick = $tick->getTicket($ticketID);
//print_r($open_tick);
$customer_details = $others->getCustomer($open_tick["customer_userID"]);
$_SESSION['customer_userID'] = $open_tick["customer_userID"];


if(isset($_POST['submit'])) {
    if ($tick->addTicket()) {
        echo '<script>alert("Ticket Assigned Successfully")</script>';
        header("location:AgentDashboard.php");
    }
    else
        echo '<script>alert("Failed to Assign Ticket")</script>';
...
<head>
    ...
    <!-- site metas -->
    <title>Tickets-Dashboard : MUST Help Desk</title>
                    ...
                    <div class="row column_title">
                        <div class="col-md-12">
                            <div class="page_title">
                                <h2 class="fa fa-ticket"> Tickets | <span class="btn btn-success">Assign Ticket</span>
                                </h2>
                            </div>
                        </div>
                    </div>
                    <form method="POST" class="" enctype="multipart/form-data">
                                ...
                                <div class="dark_bg full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h2 class="text-dark">Customer</h2>
                                        </div>
                                    </div>
                                    <div class="full graph_head">
                                        <div>
                                            <h4>Office</h4>
                                            <p class="text-dark"><?php echo $customer_details["customerID"]; ?></p>
                                        </div>
                                        <div>
                                            <h4>Ticket ID</h4>
                                            <p class="text-dark"><?php echo $ticketID; ?></p>
                                        </div>
                                        <div>
                                            <h4>Names</h4>
                                            <p class="text-dark"><?php echo $customer_details["title"] . ". " . $customer_details["fname"] . " " . $customer_details["lname"]; ?></p>
                                        </div>
                                        <div style="display: none">
                                            <input type="text" name="customer_userID"
                                                   value="<?php echo $customer_details["customer_userID"] ?>"
                                                   disabled required>
                                            <input type="text" name="customer"
                                                   value="<?php echo $customer_details["customerID"] ?>" disabled
                                                   required>
                        ...
                        <div class="row column1">
                            <div class="col-md-12 col-lg-12">
                                <div class="dark_bg full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h2 class="text-dark">Assignment</h2>
                                        </div>
                                    </div>
                                    <div class="full graph_head">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="text-dark">Queue</label><br>
                                                    <select class="form-control form-control-lg" name="queue">
                                                        <option class="" readonly disabled selected>select</option>
                                                        <?php
                                                        foreach ($others->getQueue() as $item) {
                                                            echo '<option value="' . $item["queueID"] . '">' . $item["queueID"] . '</option>';
                                                        }
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="text-dark">Owner</label><br>
                                                    <select class="form-control form-control-lg" name="owner">
                                                        <option class="" readonly disabled selected>select</option>
                                                        <?php
                                                        foreach ($others->getAgents() as $item) {
                                                            echo '<option value="' . $item["agentID"] . '">' . $item["agentID"] . '</option>';
                                                        }
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="text-dark">Responsible</label><br>
                        ...
                        <div class="row column1">
                            <div class="col-md-12 col-lg-12">
                                <div class="dark_bg full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h2 class="text-dark">Service Level Agreement</h2>
                                        </div>
                                    </div>
                                    <div class="full graph_head">
                                        <div class="form-row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="text-dark">Service</label><br>
                                                    <select class="form-control form-control-lg" name="service"
                                                            id="service">
                                                        <option class="" readonly disabled selected>select</option>
                                                        <?php
                                                        foreach ($others->getService() as $item) {
                                                            echo '<option value="' . $item["serviceID"] . '">' . $item["name"] . '</option>';
                                                        }
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="text-dark">SLA</label><br>
                                                    <input type="text" class="form-control form-control-lg" name="SLA"
                                                           value="" id="sla" disabled>
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg" name="priority">
                                                        <?php
                                                            $p = $others->getOffice($customer_details["customerID"])["priority"];
                                                            if($p == "HIGH"){
                                        ...
                                        <div class="form-row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label class="text-dark">State</label><br>
                        ...
                        <div class="row column1">
                            <div class="col-md-12 col-lg-12">
                                <div class="dark_bg full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h2 class="text-dark">Communication</h2>
                                        </div>
                                    </div>
                                    <div class="full graph_head">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="to_customer" class="form-control form-control-lg"
                                                   value="<?php echo $customer_details["email"]; ?>" required>
                        ...
                        <div class="row column1">
                            <div class="col-md-12 col-lg-12 text-center">
                                <button type="submit" name="submit" class="btn btn-dark w-25 m-2">Assign</button>
                            </div>
