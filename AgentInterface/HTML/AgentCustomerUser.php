...
if (isset($_POST['submit'])) {
    $user = new LgCustomer();
    if ($user->addCustomerUser()) header("location: AgentDashboard.php"); else
...
<head>
    ...
    <!-- site metas -->
    <title>Customer User : MUST Help Desk</title>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="full">
                        ...
                        <div class="logo_section">
                            <a href="#"><img class="img-responsive" src="../../Assets/images/logo.png"
                                             alt="#"/></a>
                        </div>
                    ...
                    <div class="row column_title">
                        <div class="col-md-12">
                            <div class="page_title">
                                <h2 class="fa fa-user"> Customer User | <span class="btn btn-success">Add User</span>
                                </h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="dark_bg full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0" data-toggle="collapse" data-target="#collapseExample2" aria-expanded="true" aria-controls="collapseExample2">
                                        <h4 class="text-dark"><span class="dropdown-toggle mr-2"></span>Click Here to Upload a file containing users</h4>
                                        <i class="text-danger font-weight-bold">Note: Must be of type csv or xls or excell file</i>
                                    </div>
                                </div>
                                <div class="collapse hide" id="collapseExample2">
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <div class="full graph_head">
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <input type="file"  name="fileUsers" class="form-control-file">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="submit" name="submit_file" class="btn btn-dark w-25">
                                                    </div>
                    ...
                    <form method="POST" class="form-group">
                        <div class="row column1">
                            <div class="col-md-12 col-lg-12">
                                <div class="dark_bg full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0" data-toggle="collapse" data-target="#collapseExample" aria-expanded="true" aria-controls="collapseExample">
                                            <h4 class="text-dark"><span class="dropdown-toggle mr-2"></span>Click to Fill Form</h4>
                                        </div>
                                    </div>
                                    <div class="collapse hide" id="collapseExample">
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6">
                                                <div class="full graph_head">
                                                    <h4 class="text-dark pt-1 pb-1">Personal Information</h4>
                                                    <div class="form-group">
                                                        <label class="text-dark">Title or Salutation</label>
                                                        <input type="text" name="title"
                                                               class="form-control form-control-lg"
                                                               placeholder="Mr/Mrs/Ms etc" required>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-dark">CustomerID</label>
                                                    ...
                                                    <h4 class="text-dark pt-2 pb-2">Address</h4>
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="full graph_head">
                                                    <h4 class="text-dark pt-1 pb-1">Login Credentials</h4>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="text-dark">Enter Password</label>
                                                        <input type="password" minlength="8" name="password"
                                                               class="form-control form-control-lg" placeholder="" required>

                                                    </div>
                                                    <div class="form-group">
                                                        <label class="text-dark">Re-enter Password</label>
                                                        <input type="password" minlength="8" name="repassword"
                                                               class="form-control form-control-lg" placeholder="" required>
                                                    </div>
