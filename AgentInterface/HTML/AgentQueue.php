...
require "../PAGE_LOGIC/LgQueue.php";
$queue = new LgQueue();
...
<head>
    ...
    <!-- site metas -->
    <title>Queue : MUST Help Desk</title>
                    ...
                    <div class="row column_title">
                        <div class="col-md-12">
                            <div class="page_title">
                                <h2 class="fa fa-bars"> In My Queue <span class="badge badge-dark">5</span> |
                                </h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="dark_bg full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2 class="text-dark">New in Queue</h2>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="full graph_head margin_bottom_30">
                                                ...
                                                <div class="table-responsive-sm">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="font-weight-bold">Changed</th>
                                                            <th class="font-weight-bold">Sender</th>
                                                            <th class="font-weight-bold">State</th>
                                                            <th class="font-weight-bold">Queue</th>
                                                            <th class="font-weight-bold">Owner</th>
                                                            <th class="font-weight-bold">CustomerID</th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        <?php $queue->getAgentQueueNew($_SESSION['agent_id'])?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                    ...
                    <div class="row column1">
                        <div class="col-md-12 col-lg-12">
                            <div class="dark_bg full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2 class="text-dark">Queue History</h2>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                                            ...
                                            <div class="table_section padding_infor_info">
                                                <div class="table-responsive-sm">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                        <?php $queue->getAgentQueueH($_SESSION['agent_id'])?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
