...
$g = $agent->getData("SELECT * FROM agent WHERE email='" . $_SESSION["agent_email"] . "'");
$_SESSION["agent_id"] = $g[0]["agentID"];
$_SESSION["agent_names"] = $g[0]["fname"] . " " . $g[0]["lname"];

$tickets = $agent->getData("SELECT * FROM tickets WHERE owner='" . (int)$_SESSION['agent_id'] . "'");
$openTickets = $agent->getData("SELECT count(*) as count FROM open_tickets WHERE valid=1");
...
<head>
    ...
    <!-- site metas -->
    <title>Agent Dashboard : MUST Help Desk</title>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="full">
                        ...
                        <div class="logo_section">
                            <a href="AgentDashboard.php"><img class="img-responsive" src="../../Assets/images/logo.png"
                                                      alt="#"/></a>
                        </div>
                    ...
                    <div class="row column_title">
                        <div class="col-md-12">
                            <div class="page_title">
                                <h2 class="fa fa-home"> Dashboard</h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="dark_bg full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2 class="text-dark">Queue Metric</h2>
                                    </div>
                                </div>
                                <div class="full graph_head">
                                    <div class="">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="table-responsive-sm" >
                                                    <table class="table table-striped ">
                                                        <thead>
                                                        <tr>
                                                            <th><span class="font-weight-bold text-dark">Queue</span>
                                                            </th>
                                                            <th><span class="font-weight-bold text-dark">New</span></th>
                                                            <th><span class="font-weight-bold text-dark">Open</span>
                                                            </th>
                                                            <th><span class="font-weight-bold text-dark">Pending Reminder</span>
                                                            </th>
                                                            <th><span class="font-weight-bold text-dark">Total</span>
                                                            </th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                                        ...
                                                        foreach ($tickets as $ticket) {
                                                            if ($ticket["state"] == "PENDING") $newTickets += 1;
                                                            if ($ticket["state"] == "PROCESSING") $progressTickets += 1;
                                                        }
                                                        echo '<tr>
                                                                    <td>' . $tickets[0]['queueID'] . '</td>
                                                                    <td>' . $newTickets . '</td>
                                                                    <td>' . $openTickets[0]["count"] . '</td>
                                                                    <td>' . $progressTickets . '</td>
                                                                    <td>' . $newTickets + $progressTickets + $openTickets[0]["count"] . '</td>
                    ...
                    <div class="row column1">
                        <div class="col-md-12 col-lg-12">
                            <div class="dark_bg full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2 class="text-dark">Escalations</h2>
                                    </div>
                                </div>
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h5 class="text-dark">No Available information!</h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row column1">
                        <div class="col-md-12 col-lg-12">
                            <div class="dark_bg full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2 class="text-dark">Reminders</h2>
                                    </div>
                                </div>
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
